                                ...
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="post-like"><img src="{{asset("front/img/bg-img/16.jpg")}}" alt=""> <span>392</span></a>
                                            <a href="#" class="post-comment"><img src="{{asset("front/img/bg-img/16.jpg")}}" alt=""> <span>10</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single-video-post">
                        <img src="{{asset("front/img/bg-img/16.jpg")}}" alt="">
                        <!-- Video Button -->
                        <div class="videobtn">
